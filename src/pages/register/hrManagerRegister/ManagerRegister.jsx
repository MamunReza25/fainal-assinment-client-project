    ...
    return (
        <div className='flex justify-center items-center flex-col h-screen w-full'>
            <div className='py-1 md:py-5'>
                ...
                <h1 className='header'>Create an HR Manager</h1>
                <p className='des'>Start managing your team and company assets smarter—create your HR account on AssetVerse today</p>
            </div>
            {/* register form */}
